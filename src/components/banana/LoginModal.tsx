          ...
          <div className="flex h-full w-full flex-col justify-between px-2 py-5 md:w-[60%] md:px-4 md:pb-6 md:pt-5">
            ...
            <div className="mt-5 space-y-3 sm:mt-6">
              <button
                ...
                className="inline-flex w-full items-center justify-center space-x-3 rounded-lg border-2 border-[#363b4e] px-3 py-2.5 text-sm font-semibold shadow-sm transition-colors hover:border-[#ffcc33] focus:outline-none focus:ring-2 focus:ring-[#ffcc33]/30 disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {loading ? (
                ...
                <p className="text-white">{loading ? (isZh ? '跳转中...' : 'Redirecting...') : t('google_login')}</p>
              </button>
