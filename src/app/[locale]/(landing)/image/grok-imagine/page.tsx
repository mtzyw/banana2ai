...
const STEPS = [
  {
    title: '输入您的构想',
    desc: '在 Grok Imagine 文本框中输入详细的提示词。Grok 上的 FLUX.1 模型擅长理解复杂的自然语言和空间描述，将您最抽象的创意想法转化为精准的视觉指令。',
  },
  {
    title: '选择纵横比',
    desc: '为您的平台选择完美的尺寸。无论是 Instagram 快拍还是 YouTube 缩略图，Grok Imagine 都能适应您的需求，提供多种宽高比选项以满足不同场景的创作要求。',
  },
  {
    title: '生成并下载',
    desc: '点击生成，观看 Grok Imagine 将您的想法变为现实。立即下载您的高分辨率 AI 艺术作品，且无水印，随时可用于商业项目和个人创作。',
  },
];
...
const FAQS = [
  {
    q: 'Grok Imagine 免费吗？',
    a: '是的，Grok Imagine 提供强大的免费在线层级，让每个人都能体验 Grok 上 FLUX.1 模型的力量。我们致力于让高质量的艺术生成触手可及。核心的 Grok Imagine 体验旨在永久免费，标准使用无需付费。您可以生成惊艳的图像，测试 Grok AI 艺术生成器的功能，并下载您的作品，无需输入信用卡信息。',
  },
  {
    q: 'Grok Imagine 保护隐私吗？',
    a: '隐私是 Grok Imagine 的首要任务。与许多其他平台不同，我们确保您的提示词和生成的图像受到最高级别的安全保护。当您使用我们的 Grok AI 艺术生成器时，您的个人数据是安全的。未经您的同意，我们不会使用您的私人生成内容来训练公共模型。',
  },
  {
    q: 'Grok Imagine 好用吗？',
    a: '当然。Grok Imagine 被广泛认为是当今可用的最好的 Grok AI 艺术生成器。通过利用 Grok 上尖端的 FLUX.1 模型，它在文本渲染、照片写实感和提示词遵循方面优于竞争对手。无论您将其与 Midjourney 还是 DALL-E 相比，Grok Imagine 都因其完美处理排版和复杂指令的能力而脱颖而出。',
  },
  {
    q: 'Grok Imagine 会限制前卫或无过滤的艺术内容吗？',
    a: 'Grok Imagine 以提供无过滤的创意而闻名，并保持着比其他平台限制更少的声誉。虽然我们遵守法律和安全准则以防止伤害，但 Grok Imagine 保留了高度的创作自由，常被社区称为"辛辣模式 (spicy mode)"。Grok 上的 FLUX.1 模型旨在理解语境和幽默，允许创作其他 AI 工具可能屏蔽的讽刺和前卫内容。',
  },
  {
    q: 'Grok Imagine 对讽刺和成人主题的开放程度如何？',
    a: 'Grok Imagine 提供了相当大范围的创作自由。它允许用户生成包括讽刺、幽默和艺术概念的内容，这些内容可能会被其他平台上更严格的过滤器标记。Grok 上的 FLUX.1 模型经过调优，允许更广泛的主题，使其成为寻求无拘束表达的用户的首选 Grok AI 艺术生成器。然而，Grok Imagine 仍然禁止非法或未经同意的内容，以确保安全的生态系统。',
  },
];
