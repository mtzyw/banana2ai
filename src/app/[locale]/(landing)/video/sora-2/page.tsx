...
const STEPS = [
  {
    ...
    title: '输入你的文字提示词',
    desc: '用自然语言描述你想创作的视频场景。Sora 2 能理解复杂的多层次指令，精准还原你的创意构想。',
  },
  {
    icon: 'https://static.banana2ai.net/images/icons/step-video.webp',
    title: '选择视频参数',
    desc: '根据需求选择视频分辨率、时长和宽高比，无论是竖屏社交媒体还是横屏影院格式，Sora 2 均可完美适配。',
  },
  {
    icon: 'https://static.banana2ai.net/images/icons/step-prompt.webp',
    title: '点击生成视频',
    desc: '基于云端的 Sora 2 引擎将处理你的请求。无需高性能电脑，只需稳定的网络连接即可享受完整功能。',
  },
  {
    icon: 'https://static.banana2ai.net/images/icons/step-settings.webp',
    title: '下载并使用',
    desc: '生成完成后即刻下载你的视频，可用于商业项目、社交媒体、教育内容或任何创意用途。',
  },
];
...
const FEATURES = [
  {
    title: '无与伦比的照片级真实感与纹理精度',
    desc: 'Sora 2 的定义性特征在于其令人叹为观止的视觉保真度。AI 视频领域长期存在"恐怖谷"难题，而 Sora 2 彻底攻克了这一难关——从玻璃反射的精确光学行为到布料在风中自然飘动的褶皱，每一个细节都与真实世界如出一辙。',
  },
  {
    title: '先进的物理引擎与时间一致性',
    desc: 'Sora 2 最重要的飞跃之一，是对物理学和因果关系的深度理解。过去的视频模型常将物体处理为色彩变化的模糊团块，导致不自然的运动效果。Sora 2 真正理解重力、动量和物质属性，流体动力学、碰撞和自然现象的呈现都符合真实世界的物理规律。',
  },
  {
    title: '精准提示词遵循与创意控制',
    desc: 'Sora 2 为创作者提供了前所未有的输出控制能力。Sora 2 内置的自然语言处理单元经过精心调优，能够理解指令的字面意义和内在意图。无论是指定特定的摄影运动、情绪基调还是风格参考，Sora 2 都能精准实现你的完整创意愿景。',
  },
];
...
const BENEFITS = [
  {
    icon: 'https://static.banana2ai.net/images/icons/step-describe.webp',
    title: '电影人和导演',
    desc: '对于影视专业人士而言，Sora 2 是终极的预可视化和补充镜头工具。导演可以用 Sora 2 即时将复杂场景绘制成分镜图，在剧组进场之前测试镜头角度和布光方案，从而节省大量时间和预算。',
  },
  {
    icon: 'https://static.banana2ai.net/images/icons/step-video.webp',
    title: '数字营销人员和机构',
    desc: '速度是现代营销的硬通货。Sora 2 赋能机构在数分钟而非数周内制作高端商业视频内容。无论是动感的社交媒体广告、产品展示还是品牌情绪视频，Sora 2 都能以惊人速度交付成果。',
  },
  {
    icon: 'https://static.banana2ai.net/images/icons/step-prompt.webp',
    title: '游戏开发者',
    desc: '游戏开发需要大量资源用于资产创作。Sora 2 通过生成动态纹理、环境背景和过场动画原型来加速这一流程。开发者可以用 Sora 2 可视化游戏机制或氛围概念，无需耗费大量时间和资金进行全面制作。',
  },
  {
    icon: 'https://static.banana2ai.net/images/icons/step-settings.webp',
    title: '教育工作者和内容创作者',
    desc: '用视觉辅助手段解释复杂概念变得前所未有的简单。教育工作者可以用 Sora 2 生成历史重演、科学可视化和地理旅游内容，无需预算支持。YouTube 创作者和在线课程制作者则能创作出令受众叹服的专业级教育内容。',
  },
];
...
const FAQS = [
  {
    q: 'Sora 2 是什么？它是如何工作的？',
    a: 'Sora 2 是最新一代的先进文字转视频生成模型，采用基于 Transformer 的架构，能够根据简单的文字指令生成长达一分钟（或在扩展模式下更长）的高保真视频。与早期系统不同，Sora 2 能够推理视觉场景中的物体、动作和关系，实现符合物理规律的真实动态效果。',
  },
  {
    q: 'Sora 2 与上一个版本有何不同？',
    a: 'Sora 2 相较于原版本实现了巨大飞跃。主要改进包括：增强的 4K 分辨率支持、能精确模拟流体动力学和重力的高级物理引擎，以及更出色的提示词遵循能力。与此同时，对话自然性、动作流畅度和整体渲染精度均有显著提升。',
  },
  {
    q: '我可以将 Sora 2 生成的视频用于商业项目吗？',
    a: '可以！Sora 2 为你生成的视频授予完整的商业使用权，前提是你使用的是符合条件的专业套餐。这意味着你可以将视频用于电视广告、YouTube 变现、故事片和营销活动等商业场景，无需额外支付授权费用。',
  },
  {
    q: 'Sora 2 支持竖屏格式的社交媒体视频吗？',
    a: '完全支持。Sora 2 提供强大的宽高比控制功能。你可以生成标准 16:9 宽屏（适用于影院和电视）、9:16 竖屏（适用于 TikTok、Instagram Reels 和 Shorts）等多种格式。Sora 2 会根据你选择的宽高比智能调整画面构图。',
  },
  {
    q: '使用 Sora 2 需要高性能电脑吗？',
    a: '不需要！Sora 2 是基于云端的解决方案，所有繁重的计算工作都在我们强大的服务器集群上完成。你无需昂贵的游戏电脑或高端显卡，只需稳定的网络连接和网页浏览器，即可享受 Sora 2 的全部功能。',
  },
  {
    q: 'Sora 2 如何保障我的数据和内容安全？',
    a: '我们将用户安全和负责任的 AI 使用置于首位。Sora 2 内置安全机制，防止生成暴力、仇恨或不当内容。此外，所有视频生成数据均经过加密处理。我们不会将你的私人、非公开输入用于训练模型，你的创意成果始终受到保护。',
  },
];
